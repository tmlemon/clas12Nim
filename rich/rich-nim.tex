...
alignment of the whole RICH detector is shown for one aerogel tile in Fig.~\ref{Fig:Align}. After alignment, the resolution improve towards
the TDR projected values, that are 4.5 mrad for single photon detection and 1.5 mrad for the average over all the photons 
associated with the hadron track. Such preliminary Cherenkov angle resolution is already sufficient for an effective hadron
