\begin{abstract}
  ...
  to provide the primary electron trigger. Each calorimeter package consists of an existing CLAS EC module and a
  new pre-shower calorimeter (PCAL) located in front of the EC to extend the radiation length at 12~GeV. Both
  calorimeters use a novel triangular hodoscope geometry with stereo readout, while the PCAL uses an upgraded
