...
\label{fig:S10_4_2}
\end{figure}
results are shown in (Fig.~\ref{fig:S10_4_1}) for the polar and azimuthal angles of the neutron momentum vector.  Using the angle cuts indicated the observed correlation of the neutral cluster velocity with the tagged neutron momentum is shown in Fig.~\ref{fig:S10_4_2} compared to the expected correlation for a particle with the neutron mass.   
