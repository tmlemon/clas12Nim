...
\begin{picture}(50,50) 
\put(0,255)
{\hbox{\includegraphics[angle=-90,width=0.80\textwidth,natwidth=610,natheight=642]{pics/install.pdf}}}
\end{picture} 
\caption{{\bf [Replace]} (Color Online) Steps in the CTOF counter installation sequence. (a) Mount
counter to installation cart, (b) Move counter into solenoid from the downstream end and rotate in
azimuth to proper position, (c) Pivot counter radially into proper installation position, (d) Attach the
counter to the support structure.}
\label{install}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
