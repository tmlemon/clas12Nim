...
The bottom sub-figure is a histogram of the tracks' TRKDOCA distribution.  It is approximately flat as
expected, since the track density is approximately constant over the small solid
angle of a single drift cell.  It shows a dip at zero, which is a real effect and is
due to both an inefficiency and a spreading out of the arrival time of ionized electrons when the track is
