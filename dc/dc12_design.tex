...
We performed tracking simulations with perfect knowledge of drift chamber
location (alignment) and perfect knowledge of the B-field, and assuming
...
\begin{picture}(35,35)
\put(-70,0)
{\hbox{\includegraphics[width=0.9\columnwidth,natwidth=610,natheight=642]{img/simulated-resolution.png}}}
\end{picture}
...
consists of about 0.02 r.l. before the R1 chambers due to an assumed 5cm LH2
target, the presence of our large Cerenkov counter and the remainder being air.
The total material in the R1, R2 and R3 chambers (filled with a 90/10 mixture
of argon/CO2) and the intervening air also amounts to about 0.02 r.l.
