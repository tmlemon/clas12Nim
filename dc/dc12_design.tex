...
When the CLAS detector was upgraded to become the CLAS12 detector~\cite{dcnim}, the
...
Because the previous CLAS drift chamber system~\cite{dcnim} operated 
...
Refer to our 
article on the previous CLAS detector~\cite{clasnim} and our article 
...
be moved out to maintenance position and back to the operating 
