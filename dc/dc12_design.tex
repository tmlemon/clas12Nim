...
momentum $1\%$ and its angle to 1 mrad.  
...
accurately  & $sin \theta ~d \phi < 1 mrad$ & $+/- 6^\circ$ stereo angle   \\ \hline
  & $dp/p < 1\% $ & identical cells (each superlayer)  \\ \hline
Select exclusive reaction; &    & $250~\mu$m  accuracy \\ 
