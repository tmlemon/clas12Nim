...
The CEBAF Large Acceptance Spectrometer (CLAS12), built for the 12 GeV
upgrade of Jefferson Lab and located in Hall B, 
is built around a superconducting toroidal magnet.
The six coils of this toroid divide the detector
azimuthally into six sectors.  Each sector contains three multi-layer 
drift chambers for reconstructing the trajectories of charged particles
originating from a fixed target.  

Each of the 18 planar chambers has two `superlayers' of six layers each,
with the wires in the two adjacent superlayers oriented at $\pm 6^{\circ}$
stereo angle, respectively.
Each layer has 112 hexagonal cells spanning a range from about
