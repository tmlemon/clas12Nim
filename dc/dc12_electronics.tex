...
\begin{picture}(50,50)
\put(20,20)
{\hbox{\includegraphics[width=0.7\textwidth,natwidth=610,natheight=642]{img/hvtb-layout.png}}}
\end{picture}
...
\begin{picture}(50,50)
\put(-10,10)
{\hbox{\includegraphics[width=0.25\textwidth,natwidth=610,natheight=642]{img/stb-layout.png}}}
\end{picture}
...
The low-voltage power supplies were also isolated from the on-chamber STB's.
The primary grounding point was at the High Voltage supply crates accomplished
by the use of a ground wire for every high-voltage 16-wire multi-cable.
