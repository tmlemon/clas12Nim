...
chamber is shown in Fig.~\ref{generic-chamber-sketch}, with parts indicated.
...
\begin{picture}(50,50)
\put(10,-10)
{\hbox{\includegraphics[width=0.5\columnwidth,natwidth=610,natheight=642]{img/generic-chamber-sketch.png}}}
\end{picture}
...
\special{psfile=img/r2_inserts.eps hscale=70 vscale=70 hoffset=0 voffset=0}  
\caption{\small{}}
\label{dc-corner}
\end{figure}   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plating. 
A small diameter for the field wire is important because it means that they 
could be strung at lower tension than a larger wire for the same gravitational sag.  
...
our choice violated the ``20~kV/cm rule'' proposed by 
Fabio Sauli (Ref~\cite{sauli_cathode_emission}) and others
