...
feedthroughs (part ``2'' in Fig.~\ref{wire-attachment}) are glued into place.
Later, during the wire stringing phase, described in Section~\ref{stringing},
the crimp pins (part ``3'') are fitted into the feedthrough and crimped to
hold the wire.  During the electronics board installation phase (see Sections
~\ref{electronics-installation} and ~\ref{stb-hvtb-installation} for more
