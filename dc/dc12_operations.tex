...
This mixed-voltage scheme has a couple of advantages over a scheme in
...
We used the drift chamber design program, GARFIELD\ref{GARFIELD}, to determine the voltages
...
We set the discriminator levels in the DCRB's to reduce the accidental hit occupancy (with no beam) due to electronic
