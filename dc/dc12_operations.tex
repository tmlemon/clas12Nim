...
Fig.~\ref{layer-vs-wire} is a histogram of wire hits plotted as
a function of layer (1 - 36 on the vertical scale) for each of the six
sectors.  Note a R1 chamber contains layers 1 - 12, an R2 layers 13-24 and an 
R3 layers 25 - 36. The horizontal axis shows the wire number in each layer (1 - 112).  
