...
of offset type $\del x, \del y, \del z, \theta x, \theta y, \theta z$, one at
...
could have had 18 free parameters, but in practice we had 12 free parameters:
 $\del x, \del y, \del z, and \theta y$ for each of the 3 chambers: R1, R2 and R3
...
In addition we have functions to correct for  wire sag due to 
gravitational forces and endplate bowing, which can cause 1 - 2 millimeter
...
\subsubsubsection{T0 Determination}
\hskip 0.15 in
