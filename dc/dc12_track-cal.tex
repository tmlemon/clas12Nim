...
\begin{picture}(50,50)
\put(-60,10)
{\hbox{\includegraphics[width=.5\textwidth,natwidth=610,natheight=642]{img/resids-vs-layer-after.png}}}
\end{picture}
...
\begin{figure}[htpb]
\vspace{8cm} 
\special{psfile=img/garfield.eps hscale=100 vscale=100 hoffset=30 voffset=30}
