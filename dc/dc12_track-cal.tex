...
We now discuss the time corrections and the time to distance calibration in more detail.
...
\begin{figure}[htpb]
\vspace{8cm} 
\special{psfile=img/garfield.eps hscale=70 vscale=70 hoffset=0 voffset=-100}
