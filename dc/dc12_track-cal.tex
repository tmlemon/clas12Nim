...
Fig.~\ref{xvst} provides an illustration of the local-angle dependence
...
simple geometrical reasoning, $Dmax_{\alpha} = Dmax \times cos(30-\alpha)$.
...
Fig.~\ref{garfield-isochrones} shows a 0 degree track and a 30 degree
...
as shown in Fig.~\ref{garfield_isochrones}b.  These effects can be modeled by a 
...
\begin{figure}[htb]
\vspace{12.cm} 
\special{psfile=img/tvsx.eps hscale=75 vscale=75 hoffset=-10 voffset=0}
...
\begin{picture}(50,50)
\put(5,-15)
{\hbox{\includegraphics[width=0.9\textwidth,natwidth=610,natheight=642]{img/resids-vs-layer-before.png}}}
\end{picture}
...
at 46.5 cm radius but displace azimuthally away from the sector mid-plane.  In summary, we 
measured $B_x, ~B_y, ~B_z$ at 40 
...
the magnetic field from our models to that measured for the $40 X 6 = 240$ measurements
...
model, our first adjusted model in which each coil is identical in shape and position and
our latest model in which each coil has the same shape but individual coil positions are
asjusted to give the best agreement with the measurements. 
...
\begin{picture}(50,50)
\put(10,-5)
{\hbox{\includegraphics[width=.65\textwidth,natwidth=610,natheight=642]{img/bmodel-bmeasured.png}}}
\end{picture}
