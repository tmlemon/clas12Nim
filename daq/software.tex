...
The CLAS12 online data monitoring is the set of programs attached to Event Transfer System and processing data in real time. One of such program's output is shown on Fig.\ref{fig:online_monitor}. Monitoring system allows shift takers to insert histograms into electronic logbook by one click.
