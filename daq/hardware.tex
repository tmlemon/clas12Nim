...
\begin{figure}[hbt]
	...
	\caption{CAEN V1190 TDC module (V1190). 128-channel 100ps LSB TDC board in VME format is shown. Another board in use is V1290 with 32 channels and 25 ps LSB.}
