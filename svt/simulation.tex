...
\begin{figure}[hbt]
\includegraphics[width=0.9\columnwidth,keepaspectratio]{PtResol.jpg}
...
\begin{figure}[hbt]
\includegraphics[width=0.8\columnwidth,keepaspectratio]{centroid-residual-mc.png}
...
\begin{figure}[hbt] 
\centering 
\includegraphics[width=0.7\columnwidth,keepaspectratio]{solenoid-field.jpg}
