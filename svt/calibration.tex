...
\begin{figure}[hbt] 
\centering 
\includegraphics[width=\columnwidth,keepaspectratio]{thrdisp.png}
\caption{Typical threshold dispersion within a chip.}
\label{fig:thrdisp}
\end{figure}

\begin{wrapfigure}{l}{0.5\columnwidth}
\includegraphics[width=0.5\columnwidth]{enc.png}
...
\begin{figure}[hbt] 
\centering 
\includegraphics[width=\columnwidth,keepaspectratio]{encmodule.png}
...
\begin{figure}[hbt] 
\centering 
\includegraphics[width=\columnwidth,keepaspectratio]{encstriplength.png}
...
\begin{figure}[hbt] 
\centering 
\includegraphics[width=\columnwidth,keepaspectratio]{occ_thr.png}
...
\begin{wrapfigure}{l}{0.5\columnwidth}
\includegraphics[width=0.5\columnwidth]{signal-gamma.png}
