...
An example of unwrapping the film off the lexan strip is shown in \F{filmOnStrip}. Several companies produced various test. In the end the
job was awarded to ECI~\cite{ECI}. The typical reflectivity of the refurbished mirrors is shown in \F{reflectivityAfter}.
...
The mathematical shape of the mirrors has been build in the geant4 simulation, see \F{alignmentSimulation}. When a laser line is directed at the mirror,
...
The laser setup for the mirror alignment is shown in \F{laserAlignment}. A 3 mW, $635 nm$ laser was placed, relative to the detector,
