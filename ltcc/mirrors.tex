...
An example of unwrapping the film off the Lexan strip is shown in \F{filmOnStrip}. Several companies produced various test samples with various protective material films. The job was eventually awarded to ECI \cite{ECI}.
...
cover the gaps, see \F{gapBeforeAndAfter}.
...
In \F{reflectivityBeforeAndAfter} (bottom) a typical spectrum of reflectivity that applies to all cylindrical, elliptical,
...
%\begin{figure}
%\centering
%	\includegraphics[width=0.99\columnwidth, keepaspectratio]{img/laserAlignment1.png}
%	\includegraphics[width=0.99\columnwidth, keepaspectratio]{img/laserAlignment2.png}
