...
Ref.~\cite{sim-nim}. A 3D view of the simulated geometry of the LTCC is shown in \F{simOverview}.
...
The LTCC box support structure was imported from the engineering model shown in \F{boxCut}. This includes the
