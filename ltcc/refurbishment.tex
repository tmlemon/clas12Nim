...
samples, likely due to 17~years of aging, see \F{reflectivityGain}.
...
One particular combination among the described scenarios is given as an example in \F{photonYieldStudy} for pions,
...
The results are summarized in \F{refurbishmentGains} for the two main scenarios: mirror re-coating and PMT quantum
