...
shows a degraded reflectivity compared to the values at installation, probably due to  17 years of aging, see \F{reflectivityGain}.
...
reflectivity is shown in \F{reflectivityGain}.
...
The $C_4F_{10}$ reflectivity is shown in \F{c4f10RefrIndex}. A detailed study of the detector response to electrons and pions used the Frank–Tamm to calculate
the Cherenkov radiation yield as a function of wavelengh and momenta, see for example \F{photonYieldStudy}.
...
The results have been summarize in \F{refurbishmentGains} for two main scenarios: mirrors re-coating and PMT's quantum efficiency improvements.
