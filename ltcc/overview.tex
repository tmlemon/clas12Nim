...
The heavier C$_4$F$_{10}$ gas can still be used to discriminate pions from kaons (see \F{newScope}), thus the detector was refurbished to a Low Threshold Cherenkov Counter (LTCC).
