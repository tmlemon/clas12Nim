...
the single photoelectron signal (SPE) was reduced on average by 374~V, see \F{pmtHVImprovement}.
...
\begin{figure*}
	...
	\caption{Left: schematic of the PMT amplifier board, shown as a resistor chain for simplicity.
			 ...
			 using a common base amplifier, made of a fast NPN transistor NE68033 by California Eastern Laboratories.
			 In the output stage a PNP-NPN transistor is used.
