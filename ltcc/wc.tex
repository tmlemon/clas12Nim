...
accept incident shallow angles of 10$^{\circ}$-15$^{\circ}$ (typical incidence angle based on simulation studies), see \F{wcSetup}.
...
The typical reflectivity of a representative WC after recoating is shown in \F{wcStatusAfter} (top).
...
\begin{figure}
	...
	\caption{Top: typical reflectivity of a ``very poor'' WC, after refurbishment.
            ...
            This picture should be compared to \F{wcStatusBefore}. Most recoated WCs show improved reflectivity.}
