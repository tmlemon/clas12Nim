...
PMT \cite{Koczon:1457653} is shown in \F{pmtQuantumEfficiencyGainAndExample} (top).
...
shown in \F{pmtTestingSetupAndptQEResults} (top). The setup used a monochromator with a precision of 0.35 nm and two PMTs (one for the measurement,
...
In \F{pmtQuantumEfficiencyGainAndExample} (bottom) an example of deposition of a test glass is shown. Notice that the coating is almost
