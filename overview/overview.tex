...
photons. {\bf TO BE REPLACED WITH CLEAR BACKGROUND } }
\label{gemc-event}
\end{figure*}
...
\begin{figure*}[htbp!]
\centerline{
\includegraphics[width=1.0\columnwidth]{epX-in.png}
\includegraphics[width=1.12\columnwidth]{epX-out.png}}
...
small angle acceptance at the $Q^2 \approx 1.0$~GeV$^2$ limit for electrons bending towards the beam line.} 
