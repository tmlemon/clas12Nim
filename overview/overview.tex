...
versus momentum are shown in Fig.~\ref{neg-pos}. Figure~\ref{vertex} shows the production vertex as
...
\caption{The left panels show the elastic peak at 10.6~GeV beam energy as measured in 3 representative sectors.
  ...
  is due to the unmeasured neutron. The mass resolution is $\sigma_X = 45$~MeV. {(\bf Updated graphs have been
    requested.)}}
\label{elastic-peak}
%\end{figure} 
...
\caption{CND response to charged particles. Upper panels show the photomultiplier timing resolution and correlation
  in position projected from the CVT and measurement in the CND. Bottom panels show particle $\beta$ in CND vs.
  momentum measured in the CVT, showing the $\pi^-$ band (left) and the proton and $\pi^+$ bands (right).
