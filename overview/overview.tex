...
\caption{(Color Online) Solenoid magnetic stray fields with the magnet at full current and the Torus off. {\bf Dave Heddle is 
working on full field map }}
\label{stray-field1}
\end{figure}

\begin{figure}[htbp!]
\centerline{\includegraphics[width=1.2\columnwidth]{mag-field-2.png}}
\caption{(Color Online) Combined Solenoid and Torus magnetic stray fields with both magnets at full current. 
 {\bf Dave Heddle is working on full field map}}
\label{stray-field2}
\end{figure}
...
%\includegraphics[width=1.04\columnwidth]{pos-tracks.png}}
...
\begin{figure}[thbp!]
\centerline{\includegraphics[width=1.0\columnwidth]{cvt-vertex.png}}
\caption{Reconstructed z-vertex for charged tracks from an empty target cell. }
\label{cvt-vertex}
\end{figure}
