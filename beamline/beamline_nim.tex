...
\newcommand{\INFN}{Istituto Nazionale di Fisica Nucleare, Genova, Via Dodecaneso 33, 16146 Italy}
...
\begin{abstract}
%The CLAS12 detector , due to its 
This paper describes the Hall B beamline and its performance during the first year of data-taking operation using the CLAS12 detector. 
We review the beamline instrumentation used to measure and monitor the beam. This instrumentation led to excellent beam quality for energies ranging from 2.3 to 10.6 GeV at the design luminosity of $10^{35}$ cm$^{-2}$s$^{-1}$.  The instrumentation includes a 
M{\o}ller polarimeter, which can typically measure the beam polarization to an absolute precision of $\sim 2.5\%$  
\end{abstract}
