...
system nearly 20 years ago~\cite{tof-nim}. Based on the parameterization given in Eq.(\ref{nphe-eq}),
...
the hit clustering and matching algorithms are provided in Refs.~\cite{ftof-recon,recon-nim}.
