...
a clustering algorithm is used to match neighboring FTOF counter hits in time and in hit coordinate along the bar.
The assigned cluster energy is then the sum of the deposited energies in the defined cluster,
