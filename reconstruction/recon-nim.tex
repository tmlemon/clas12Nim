...
The Event IO data format \cite{evio}.
...
\subsubsection{Cherenkov Counters}

The goal of the HTCC and LTCC reconstruction algorithms is to calculate the signal strength, time, and position from the
...
four mirrors (for the HTCC) or two mirrors (for the LTCC) and hence produce four separated signals (or hits). The final signal reconstruction is done in three
