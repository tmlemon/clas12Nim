...
\begin{figure}[hbt]
	...
	\caption{Typical HLS project for one of the PCAL trigger elements. 4\% LUTs is close to the maximum possible to meet timing requirements on the following steps.}
	\label{fig:hls}
\end{figure}
...
\begin{figure}[hbt]
	...
	\caption{VIVADO project for PCAL trigger. Strategies used were ``Vivado Synthesis Defaults'' and ``Performance\_ExplorePostRoutePhysOpt''. LUT utilization is about 2/3 of the total balance.}
	\label{fig:vivado}
\end{figure}
