...
\begin{figure}[!htb]
 	...
 	\caption{(Color online) Display of event selected by the electron trigger. The trigger detectors HTCC, DC, PCAL and ECAL are indicated in the picture. The electron momentum is 4.5 GeV/c.}
	\label{fig:electron}
\end{figure}
...
\begin{figure}[!htb]
 	...
 	\caption{(Color online) Display of event selected by the muon trigger. The trigger detectors DC, FTOP, PCAL and ECAL are indicated in the picture. The particle momentum are  1.1 and 1.3 GeV/c.}
	\label{fig:muon}
\end{figure}
\noindent
 The event display with the two particles with opposite charges, selected by muon trigger, is shown in Fig.~\ref{fig:muon}.
