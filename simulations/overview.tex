...
\begin{figure}
	...
	\caption{The architecture of GEMC. The Geant4 objects are defined in an external database. Geant4 is used to simulate the
             passage of particles through materials, and hits are digitized with plugins defined by the user
