...
a workflow to eliminate any discrepancies, see \F{cadValidation}.
...
\begin{figure}
	...
	\caption{An example of comparing the GEMC simulation to the drawings and validating the geometry.
             Top: engineering drawings of the CLAS12 beamline and shielding. The start of the M\"oller shielding is 87.77 cm downstream
