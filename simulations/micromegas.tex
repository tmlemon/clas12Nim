...
made by three disk regions divided azimuthally in six identical sectors. In both subsystems each region is made by two layers, one with wires parallel to the beam and
one with wires perpendicolar to the beam (see \F{bmtGeometry}).
Each micromegas sector contain a cover layer with copper ground,
