...
The java geometry service is at \url{https://github.com/JeffersonLab/clas12-offline-software/blob/development/common-tools/clas-jcsg/src/main/java/org/jlab/detector/geant4/v2/DCGeant4Factory.java}.
...
The time window  of the DC is set to 500 ns: all geant4 steps within the same cell and time window will be collected on one hit.
