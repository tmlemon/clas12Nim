...
%	\includegraphics[width=0.99\columnwidth,keepaspectratio]{img/dcDetail.png}
	\caption{(Color Online) The GEMC implementation of the DC geometry. The solenoid volume and HTCC are also visible.
...
\begin{figure}
	...
	\caption{(Color Online) Results for DC rates for electron out-bending in the torus field.
