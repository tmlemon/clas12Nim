...
(including the adapter, ASIC and FPGA boards), the window, and the photocathodes.
Each multi-node PMT contains 64 pixels. The identification of the pixel is done in the process identification routine.
The aerogel radiators are imported from the engineering CAD models and include the triangular, squared, pentagon, and trapezoidal shapes.
...
The refractive index of the aerogel and its transparency are included in the material optical properties and taken
