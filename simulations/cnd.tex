...
\begin{figure}
	...
	\caption{(Color Online) Top: overall view of the CND detector. Three layers of scintillators are placed at increasing ``z''. Pairs of scintillators
...
The time window  of the CND is set to 5 ns: all Geant4 steps within the same paddle and time window are collected in one hit.
